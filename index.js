...
const ModoOscuro = document.querySelector("#btn-modo-oscuro");
const headerModoOscuro = document.querySelector("header");
const mainModoOscuro = document.querySelector("main");
const asideModoOscuro = document.querySelector("aside");
const botonesHeaderOscuro = document.getElementsByClassName("botonNav");

//SECCION MAIN
const cajaImagenMeme = document.getElementById("imagen");
const topText = document.getElementById("top-text");
const bottomText = document.getElementById("bottom-text");
const descargarMeme = document.getElementById("btn-download");
...
const filtroGrises = document.getElementById("escala-grises");
...
const reestablecerFiltros = document.getElementById("btn-reestablecer");
const colorDeFondo = document.getElementById("selectorColoresFondo");
const cambiarColor = document.getElementById("selectorColor");
const textSuperior = document.getElementById("superior");
const textInferior = document.getElementById("inferior");
...
//FUNCION MODO CLARO Y OSCURO
modoOscuro.onclick = () => {
  headerModoOscuro.classList.toggle("header-modo-oscuro");
...
descargarMeme = () => {
  domtoimage.toBlob(document.getElementById("caja-meme")).then(function (blob) {
...
textSuperior.oninput = () => {
  topText.textContent = textSuperior.value;
};
textInferior.oninput = () => {
  bottomText.textContent = textInferior.value;
};
...
const textoSuperiorNone = () => {
  topText.classList.toggle("top-none");
};
checkboxSuperior.addEventListener("click", textoSuperiorNone);

// display none inferior
const textoInferiorNone = () => {
  bottomText.classList.toggle("bottom-none");
};
